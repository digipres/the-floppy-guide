...
:::{note} Status: Good to Go, Open For Updates
This guide to imaging floppy disks was initially developed as part of the [Future Nostalgia project](https://www.lib.cam.ac.uk/future-nostalgia), led by [Cambridge University Library](https://www.lib.cam.ac.uk/) and supported by the [Digital Preservation Coalition](https://dpconline.org).
...
Another alternative for powering 12V 5.25-inch floppy drives, standalone SATA power adapters, such as those sold under brands like [<u>Fideco</u>](https://fideco-it.com/products/fideco-usb-3-0-to-2-5-3-5-inch-sata-ide-hdd-ssd-adapter-pl319), can also be used. These units are typically designed to provide power for external SATA devices and often expose standard SATA power connectors without requiring a full PC power supply. As with bench power supplies, care must be taken to verify correct voltage levels and pin mappings before connection. While not purpose-built for floppy hardware, they can be a compact and practical option when a traditional PSU is unavailable.
